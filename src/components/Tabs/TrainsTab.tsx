...
import { Search, Navigation, Calendar, Clock, ArrowRight, ChevronRight, CreditCard, Shield } from 'lucide-react';
...
export default function TrainsTab({ onSelectBookingItem }: TrainsTabProps) {
  ...
  const triggerCheckout = (train: Train, tClass: any) => {
    onSelectBookingItem({
      type: 'train',
              ...
              <div key={train.id} className="bg-neutral-900 border border-neutral-800 rounded-2xl p-5 md:p-6 space-y-4 shadow">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 border-b border-neutral-800">
                  <div className="flex items-center gap-2.5">
                    <div className="p-2 bg-neutral-950 border border-neutral-850 rounded-lg text-emerald-400 font-bold text-xs">
                      TRAIN
                    </div>
                    <div>
                ...
                <div className="pt-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {train.classes.map((cls) => (
                      <div 
                        key={cls.name}
                        className="bg-neutral-950 border border-neutral-850 hover:border-emerald-500/20 p-4 rounded-xl flex justify-between items-center"
                      >
                        <div>
                        ...
                        <div className="text-right flex items-center gap-3">
                          ...
                          <button 
                            onClick={() => triggerCheckout(train, cls)}
