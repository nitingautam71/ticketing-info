...
import { LayoutDashboard, Users, UserCog, CheckSquare, BookOpen, Mail, LogOut, Star, HelpCircle, Newspaper, Settings, IdCard, PhoneCall, TrendingUp, Stamp, TrainFront, ShieldCheck } from 'lucide-react';
...
const ADMIN_NAV = [
  ...
  { href: '/admin/calls', label: 'Call Clicks', icon: PhoneCall },
  ...
  { href: '/admin/trains', label: 'Rail Services', icon: TrainFront },
