...
import type { Category, OriginMarket } from '@/lib/packages/types';
...
export interface CruisePackage {
  ...
  pricing: Record<string, Record<string, Record<string, CruisePricingBreakdown>>>; // [originMarketCode][travelerType][pricingTier] -> CruisePricingBreakdown
}
